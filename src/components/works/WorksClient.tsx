...
export default function WorksClient({ projects, categories }: WorksClientProps) {
            ...
            <nav className="lg:sticky lg:top-32 space-y-2">
              {categories.map((category) => (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-3 rounded-xl text-left transition-all duration-300 cursor-pointer ${activeCategory === category.key
                ...
                >
                  ...
                  <span
                    className={`text-sm font-mono ${activeCategory === category.key
                      ? "text-pastel-pink"
                      : "text-text-muted"
                      }`}
                  >
