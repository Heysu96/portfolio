...
export const projects: Project[] = [
  ...
  {
    id: "4",
    title: "365mc 강남본점 외부LED 2편",
    category: ["ai-video"],
    date: "2025.12",
    tags: ["nanobanana", "Photoshop", "kling AI", "Hailuo AI", "CapCut"],
    thumbnail: "/project04/01.png",
    description: "365mc 강남본점 외부 LED용 AI 애니메이션 영상입니다.",
    media: [
  ...
  {
    id: "5",
    title: "365mc 노원점 줄기세포센터 오픈 기념 팝업",
    category: ["web"],
    date: "2025.12",
    tags: ["nanobanana", "Photoshop"],
    thumbnail: "/project05/01.jpg",
    description: "365mc 노원점 줄기세포센터 오픈기념으로 제작된 팝업용 이미지입니다.",
    media: [
  ...
  },
  {
    ...
    description: "365mc의 재환 고객용 상담 자료로 제작된 웹페이지입니다.",
    media: [
  ...
  {
    id: "7",
    title: "365mc LAMS 모바일용 다이어트 테스트",
    category: ["web"],
    date: "2025.11",
    tags: ["nanobanana", "Photoshop", "Figma"],
    thumbnail: "/project07/01.png",
    description: "DB 수집을 위한 365mc의 다이어트 테스트용 웹페이지입니다.",
    media: [
  ...
  {
    id: "8",
    title: "365mc 글로벌 캠페인_뉴스편",
    category: ["ai-video"],
    date: "2025.08",
    tags: ["sora", "Photoshop", "kling AI", "Hailuo AI", "CapCut"],
    thumbnail: "/project08/01.jpg",
    description: "365mc의 글로벌 확장을 알리기 위한 AI 애니메이션 영상입니다.",
    media: [
  ...
  {
    id: "9",
    title: "365mc 미국진출기념 OPEN 영상",
    category: ["ai-video"],
    date: "2025.07",
    tags: ["sora", "Photoshop", "Hailuo AI", "CapCut"],
    thumbnail: "/project09/01.jpg",
    description: "365mc의 미국LA점 오픈을 기념하여 제작된 AI 애니메이션 영상입니다.",
    media: [
